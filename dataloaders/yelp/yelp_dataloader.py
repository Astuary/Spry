...
def get_federated_datasets(
    ...
    if not os.path.exists(save_dir):
        ...
        yelp_train_all_data, yelp_test_all_data = load_yelp_federated(
        ...
        yelp_train_all_data, yelp_test_all_data = get_yelp_federated(
            num_clients = num_clients,
            save_dir = save_dir,
        )
    ...
    for client in range(num_clients):
        ...
        yelp_train_dataloader_dict[str(client)] = DataLoader(
            yelp_train_all_data[str(client)],
            batch_size=train_client_batch_size,
            num_workers=2
        )
        
        yelp_test_dataloader_dict[str(client)] = DataLoader(
