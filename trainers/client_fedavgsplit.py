...
from trainers.server_fedavgsplit import FedAvg
...
def question_answerer_train(net, train_dataloader, test_dataloader, test_dataset, test_examples, split_trainable_keys):
    if client_opt == 'sgd':
...
if __name__  == '__main__':
    ...
    if dataset == 'agnews':
        ...
        quantized_model_path = './models/models--4bit-autogptq-quantized-opt6B-v1'
